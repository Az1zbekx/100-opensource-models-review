...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Insanely-Fast-Whisper Speech-to-Text Engine")
    print("  Model: openai/whisper-large-v3 (Optimized)")
    print("==================================================")
    print("Loading model parameters (809M / 1.5B (Batched), Compute: FP16 / INT8)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Insanely-Fast-Whisper\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Insanely-Fast-Whisper STT Demo")
