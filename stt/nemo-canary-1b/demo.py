...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  NeMo-Canary-1B Speech-to-Text Engine")
    print("  Model: nvidia/canary-1b")
    print("==================================================")
    print("Loading model parameters (1.0B (FastConformer), Compute: FP16 / INT8)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: NeMo-Canary-1B\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="NeMo-Canary-1B STT Demo")
