# NeMo-Canary-1B — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #87**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** NVIDIA NeMo / PyTorch (1.0B (FastConformer))  
> **Upstream Repozitoriy:** `nvidia/canary-1b`  
...
**NeMo-Canary-1B** — NVIDIA's flagship multi-lingual speech model achieving state-of-the-art accuracy across transcription, translation, and punctuation.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Multitask speech transcription and translation with punctuation and capitalization.
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (Top-ranked on OpenASR leaderboard with punctuation restoration).
...
|---|---|---|---|---|---|
| **NeMo-Canary-1B** | **1.0B (FastConformer)** | **~0.28x** | **~4.5%** | **~700 MB** | **Multitask speech transcription and ...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up nemo-canary-1b --build
