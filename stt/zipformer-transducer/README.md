# Zipformer-Transducer — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #93**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** Icefall / k2 (65M (Zipformer))  
> **Upstream Repozitoriy:** `k2-fsa/icefall`  
...
**Zipformer-Transducer** — Fast and memory-efficient transducer model that downsamples and upsamples acoustic frames at multiple frame rates.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Next-gen Kaldi Zipformer multi-rate transducer with exceptional parameter efficiency.
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (State-of-the-art transducer speed and low streaming latency).
...
|---|---|---|---|---|---|
| **Zipformer-Transducer** | **65M (Zipformer)** | **~0.05x** | **~4.5%** | **~700 MB** | **Next-gen Kaldi Zipformer multi-rate...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up zipformer-transducer --build
