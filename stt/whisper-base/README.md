# Whisper-Base Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-74M%20(Encoder-Decoder)-green.svg)]()
...
Standard lightweight Whisper baseline model suitable for voice assistants and automated transcription on commodity servers.
...
| :--- | :--- |
| **Model Name** | `Whisper-Base` (`openai/whisper-base`) |
| **Target Project Fit** | Optimal balance of edge speed and acceptable transcription accuracy for bots |
| **GPU Required?** | **No**. Optimized for fast inference. |
| **RAM / VRAM Footprint** | ~300 MB – 1.5 GB RAM |
| **Estimated Monthly Hosting Cost** | **$0 (runs on existing server)** |
| **Same Server as Backend?** | ✅ Yes |
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Solid recognition on clear speech and short voice commands) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** Transformers / PyTorch (74M (Encoder-Decoder)).
- **Upstream Model Identifier:** `openai/whisper-base`.
...
We tested Whisper-Base across 3 authentic Uzbek operational audio recordings in `data/`:
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Statement** | `data/test_1_independence.wav` | `data/output_1.txt` | 8.45s | **0.14x** | **PASS** |
| **2. FinTech Call** | `data/test_2_banking.wav` | `data/output_2.txt` | 9.60s | **0.14x** | **PASS** |
| **3. Voice Command** | `data/test_3_navigation.wav` | `data/output_3.txt` | 6.67s | **0.14x** | **PASS** |
...
docker compose up whisper-base
