...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper-Base Speech-to-Text Engine")
    print("  Model: openai/whisper-base")
    print("==================================================")
    print("Loading model parameters (74M (Encoder-Decoder), Compute: INT8 / FP32)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper-Base STT Demo")
