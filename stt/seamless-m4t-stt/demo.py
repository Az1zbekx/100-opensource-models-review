...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  SeamlessM4T-STT Speech-to-Text Engine")
    print("  Model: facebook/seamless-m4t-v2-large")
    print("==================================================")
    print("Loading model parameters (2.3B / 1.1B (UnitY2), Compute: FP16 / INT4)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: SeamlessM4T-STT\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="SeamlessM4T-STT STT Demo")
