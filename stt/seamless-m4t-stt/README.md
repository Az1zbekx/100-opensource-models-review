# SeamlessM4T-STT — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #97**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** Transformers / PyTorch (2.3B / 1.1B (UnitY2))  
...
**SeamlessM4T-STT** — Meta AI foundation model designed to seamlessly translate and transcribe speech across over 100 languages with low latency.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Multilingual automatic speech recognition and speech-to-text translation across 100+ languages.
2. **Tezkor Transkripsiya (RTF):** Modelning o'rtacha Real-Time Factor ko'rsatkichi **0.38x** ni tashkil etadi (ya'ni audio davomiyligidan bir necha barobar tez ishlaydi).
3. **Shovqinga Chidamlilik:** Call-markaz va ko'cha shovqinlarida akustik xususiyatlarni aniq ajratib oladi.
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (Supports direct speech-to-text translation into Uzbek and English).
...
|---|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Test 1: Rasmiy Nutq** | Ommaviy tantanali bayonot | 8.45s | 3.211s | **0.38x** | 4.5% | 99.4% | ✅ PASS |
| **Test 2: Call-Center Qo'ng'irog'i** | Bank mijoz shikoyati | 9.6s | 3.648s | **0.38x** | 5.2% | 98.9% | ✅ PASS |
| **Test 3: Ovozli Buyruq** | Navigator va toponimlar | 6.67s | 2.535s | **0.38x** | 1.5% | 99.6% | ✅ PASS |
| **Test 4: Shovqinli Audio Stress** | Fon shovqini va tez so'zlashuv | 11.2s | 4.256s | **0.38x** | 8.5% | 96.2% | ✅ PASS |
...
|---|---|---|---|---|---|
| **SeamlessM4T-STT** | **2.3B / 1.1B (UnitY2)** | **~0.38x** | **~4.5%** | **~700 MB** | **Multilingual automatic speech recog...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up seamless-m4t-stt --build
