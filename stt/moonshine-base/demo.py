...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Moonshine-Base Speech-to-Text Engine")
    print("  Model: UsefulSensors/moonshine-base")
    print("==================================================")
    print("Loading model parameters (61M (Rotary Transformer), Compute: INT8 ONNX)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Moonshine-Base\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Moonshine-Base STT Demo")
