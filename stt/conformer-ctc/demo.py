...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Conformer-CTC Speech-to-Text Engine")
    print("  Model: nvidia/stt_en_conformer_ctc_small")
    print("==================================================")
    print("Loading model parameters (13M–120M (Conformer), Compute: INT8 ONNX)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Conformer-CTC STT Demo")
