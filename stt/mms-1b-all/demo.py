...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  MMS-1B-All Speech-to-Text Engine")
    print("  Model: facebook/mms-1b-all")
    print("==================================================")
    print("Loading model parameters (1.0B (Wav2Vec2 CTC), Compute: FP16 / INT8)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MMS-1B-All STT Demo")
