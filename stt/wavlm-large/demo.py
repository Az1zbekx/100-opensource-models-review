...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  WavLM-Large Speech-to-Text Engine")
    print("  Model: microsoft/wavlm-large")
    print("==================================================")
    print("Loading model parameters (315M (Gated Relative Transformer), Compute: FP16 / FP32)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="WavLM-Large STT Demo")
