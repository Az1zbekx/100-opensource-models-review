...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Wav2Vec2-XLSR-UZ Speech-to-Text Engine")
    print("  Model: facebook/wav2vec2-large-xlsr-53 (UZ)")
    print("==================================================")
    print("Loading model parameters (317M (CTC), Compute: FP32 / FP16)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Wav2Vec2-XLSR-UZ\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Wav2Vec2-XLSR-UZ STT Demo")
