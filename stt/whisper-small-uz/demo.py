...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper-Small-UZ Speech-to-Text Engine")
    print("  Model: openai/whisper-small (UZ fine-tuned)")
    print("==================================================")
    print("Loading model parameters (244M (Encoder-Decoder), Compute: INT8 / FP16)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Whisper-Small-UZ\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper-Small-UZ STT Demo")
