# Whisper-Small-UZ Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-244M%20(Encoder-Decoder)-green.svg)]()
...
Whisper Small fine-tuned on the Mozilla Common Voice Uzbek speech dataset, yielding low Word Error Rate on regional dialects.
...
| :--- | :--- |
| **Model Name** | `Whisper-Small-UZ` (`openai/whisper-small (UZ fine-tuned)`) |
| **Target Project Fit** | Domain-fine-tuned Uzbek speech recognition on Common Voice Uzbek corpus |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐⭐ (Maximized Uzbek lexicon accuracy and vernacular handling) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** Transformers / PyTorch (244M (Encoder-Decoder)).
- **Upstream Model Identifier:** `openai/whisper-small (UZ fine-tuned)`.
...
We tested Whisper-Small-UZ across 3 authentic Uzbek operational audio recordings in `data/`:
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Statement** | `data/test_1_independence.wav` | `data/output_1.txt` | 8.45s | **0.32x** | **PASS** |
| **2. FinTech Call** | `data/test_2_banking.wav` | `data/output_2.txt` | 9.60s | **0.32x** | **PASS** |
| **3. Voice Command** | `data/test_3_navigation.wav` | `data/output_3.txt` | 6.67s | **0.32x** | **PASS** |
...
docker compose up whisper-small-uz
