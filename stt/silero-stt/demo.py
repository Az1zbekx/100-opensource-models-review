...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Silero-STT Speech-to-Text Engine")
    print("  Model: snakers4/silero-models")
    print("==================================================")
    print("Loading model parameters (25M (TorchScript), Compute: INT8 / FP32)...")
