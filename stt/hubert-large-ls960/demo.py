...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  HuBERT-Large Speech-to-Text Engine")
    print("  Model: facebook/hubert-large-ls960-ft")
    print("==================================================")
    print("Loading model parameters (317M (Transformer), Compute: FP16 / FP32)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="HuBERT-Large STT Demo")
