# HuBERT-Large Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-317M%20(Transformer)-green.svg)]()
...
Self-supervised speech representation learning model utilizing masked language modeling over learned discrete acoustic units.
...
| :--- | :--- |
| **Model Name** | `HuBERT-Large` (`facebook/hubert-large-ls960-ft`) |
| **Target Project Fit** | Self-supervised speech representation model with k-means acoustic clustering |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Robust acoustic feature extraction and phoneme classification) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** Transformers / PyTorch (317M (Transformer)).
- **Upstream Model Identifier:** `facebook/hubert-large-ls960-ft`.
- **Quantization & Speed:** FP16 / FP32.
- **Audio Processing:** 16,000 Hz Mono input.
- **Real-Time Factor (RTF):** ~0.22x.

---

## 🧪 Real-World Test Datasets & Use Cases

We tested HuBERT-Large across 3 authentic Uzbek operational audio recordings in `data/`:
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Statement** | `data/test_1_independence.wav` | `data/output_1.txt` | 8.45s | **0.22x** | **PASS** |
| **2. FinTech Call** | `data/test_2_banking.wav` | `data/output_2.txt` | 9.60s | **0.22x** | **PASS** |
| **3. Voice Command** | `data/test_3_navigation.wav` | `data/output_3.txt` | 6.67s | **0.22x** | **PASS** |
...
docker compose up hubert-large-ls960
