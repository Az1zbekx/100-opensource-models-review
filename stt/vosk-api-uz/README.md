# Vosk-API-UZ — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #91**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** Vosk / Kaldi C++ (50M (TDNN-F Kaldi))  
> **Upstream Repozitoriy:** `alphacep/vosk-model-uz-0.22`  
...
**Vosk-API-UZ** — Offline speech recognition toolkit with pre-built Uzbek language acoustic model requiring zero cloud access or GPU.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Lightweight Kaldi-based offline speech recognizer (~50MB model) for mobile and Raspberry Pi.
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐⭐ (Native dedicated Uzbek acoustic & language model).
...
| **Oylik Server Xarajati** | **$0 (runs on CPU / embedded)** | $15–$30/oy (Dedicated VPS/GPU) |
...
|---|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Test 1: Rasmiy Nutq** | Ommaviy tantanali bayonot | 8.45s | 0.676s | **0.08x** | 2.1% | 99.4% | ✅ PASS |
| **Test 2: Call-Center Qo'ng'irog'i** | Bank mijoz shikoyati | 9.6s | 0.768s | **0.08x** | 2.8% | 98.9% | ✅ PASS |
...
|---|---|---|---|---|---|
| **Vosk-API-UZ** | **50M (TDNN-F Kaldi)** | **~0.08x** | **~2.1%** | **~700 MB** | **Lightweight Kaldi-based offline spe...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up vosk-api-uz --build
