...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Vosk-API-UZ Speech-to-Text Engine")
    print("  Model: alphacep/vosk-model-uz-0.22")
    print("==================================================")
    print("Loading model parameters (50M (TDNN-F Kaldi), Compute: INT8 / FP32)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Vosk-API-UZ STT Demo")
