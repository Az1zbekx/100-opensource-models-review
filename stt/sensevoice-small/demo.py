...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  SenseVoice-Small Speech-to-Text Engine")
    print("  Model: FunAudioLLM/SenseVoiceSmall")
    print("==================================================")
    print("Loading model parameters (150M (San-m Encoder), Compute: INT8 / FP16)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: SenseVoice-Small\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="SenseVoice-Small STT Demo")
