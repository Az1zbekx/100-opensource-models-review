...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper-Diarization Speech-to-Text Engine")
    print("  Model: openai/whisper + pyannote/speaker-diarization")
    print("==================================================")
    print("Loading model parameters (244M + 50M (Diarization), Compute: INT8 / FP16)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Whisper-Diarization\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper-Diarization STT Demo")
