# Whisper-Diarization — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #100**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** Whisper + PyAnnote (244M + 50M (Diarization))  
> **Upstream Repozitoriy:** `openai/whisper + pyannote/speaker-diarization`  
...
**Whisper-Diarization** — Integrated pipeline combining Whisper ASR with PyAnnote speaker diarization to label who said what in multi-party meetings.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Multi-speaker meeting transcription with speaker identification ('Who Spoke When').
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐⭐ (Disentangles alternating speakers in Uzbek customer interviews).
...
|---|---|---|---|---|---|
| **Whisper-Diarization** | **244M + 50M (Diarization)** | **~0.35x** | **~4.5%** | **~700 MB** | **Multi-speaker meeting transcription...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up whisper-diarization --build
...
`Whisper-Diarization` o'zbek tili nutqini tanib olishda yuqori natija berdi. Ushbu model **Multi-speaker meeting transcription with speaker identification ('Who Spoke When')** vazifalarida barqaror va arzon yechim bo'lib xizmat qiladi.
...
- **Asosiy Repozitoriy / Model Hub:** [https://huggingface.co/pyannote/speaker-diarization-3.1](https://huggingface.co/pyannote/speaker-diarization-3.1)
- **Qo'shimcha Manba / Upstream:** [https://github.com/MahmoudAshraf97/whisper-diarization](https://github.com/MahmoudAshraf97/whisper-diarization)
