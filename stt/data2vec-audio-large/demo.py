...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Data2Vec-Audio-Large Speech-to-Text Engine")
    print("  Model: facebook/data2vec-audio-large-960h")
    print("==================================================")
    print("Loading model parameters (315M (Transformer), Compute: FP16 / FP32)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Data2Vec-Audio-Large\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Data2Vec-Audio-Large STT Demo")
