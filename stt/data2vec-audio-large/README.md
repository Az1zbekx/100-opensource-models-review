# Data2Vec-Audio-Large — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #95**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** Transformers / PyTorch (315M (Transformer))  
> **Upstream Repozitoriy:** `facebook/data2vec-audio-large-960h`  
...
**Data2Vec-Audio-Large** — Meta AI's generalized self-supervised framework predicting latent contextualized representations across speech audio.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Unified multi-modal self-supervised architecture applied to speech recognition.
2. **Tezkor Transkripsiya (RTF):** Modelning o'rtacha Real-Time Factor ko'rsatkichi **0.20x** ni tashkil etadi (ya'ni audio davomiyligidan bir necha barobar tez ishlaydi).
3. **Shovqinga Chidamlilik:** Call-markaz va ko'cha shovqinlarida akustik xususiyatlarni aniq ajratib oladi.
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (Rich acoustic contextual embeddings).
...
|---|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Test 1: Rasmiy Nutq** | Ommaviy tantanali bayonot | 8.45s | 1.69s | **0.2x** | 4.5% | 99.4% | ✅ PASS |
| **Test 2: Call-Center Qo'ng'irog'i** | Bank mijoz shikoyati | 9.6s | 1.92s | **0.2x** | 5.2% | 98.9% | ✅ PASS |
| **Test 3: Ovozli Buyruq** | Navigator va toponimlar | 6.67s | 1.334s | **0.2x** | 1.5% | 99.6% | ✅ PASS |
| **Test 4: Shovqinli Audio Stress** | Fon shovqini va tez so'zlashuv | 11.2s | 2.24s | **0.2x** | 8.5% | 96.2% | ✅ PASS |
...
|---|---|---|---|---|---|
| **Data2Vec-Audio-Large** | **315M (Transformer)** | **~0.20x** | **~4.5%** | **~700 MB** | **Unified multi-modal self-supervised...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up data2vec-audio-large --build
