...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper-Tiny Speech-to-Text Engine")
    print("  Model: openai/whisper-tiny")
    print("==================================================")
    print("Loading model parameters (39M (Encoder-Decoder), Compute: INT8 / FP32)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper-Tiny STT Demo")
