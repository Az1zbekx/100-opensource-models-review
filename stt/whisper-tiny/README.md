# Whisper-Tiny Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-39M%20(Encoder-Decoder)-green.svg)]()
...
The smallest member of the Whisper family, requiring under 150MB RAM and running faster than real-time on single-core CPUs.
...
| :--- | :--- |
| **Model Name** | `Whisper-Tiny` (`openai/whisper-tiny`) |
| **Target Project Fit** | Ultra-lightweight real-time transcription on low-end CPUs and IoT hardware |
| **GPU Required?** | **No**. Optimized for fast inference. |
| **RAM / VRAM Footprint** | ~300 MB – 1.5 GB RAM |
| **Estimated Monthly Hosting Cost** | **$0 (runs on $4 VPS)** |
| **Same Server as Backend?** | ✅ Yes |
| **Uzbek Language Accuracy** | ⭐⭐⭐☆☆ (Basic vocabulary recognition, fastest inference footprint) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** Transformers / PyTorch (39M (Encoder-Decoder)).
- **Upstream Model Identifier:** `openai/whisper-tiny`.
...
We tested Whisper-Tiny across 3 authentic Uzbek operational audio recordings in `data/`:
...
docker compose up whisper-tiny
