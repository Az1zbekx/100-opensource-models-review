...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Moonshine-Tiny Speech-to-Text Engine")
    print("  Model: UsefulSensors/moonshine-tiny")
    print("==================================================")
    print("Loading model parameters (27M (Rotary Transformer), Compute: INT8 ONNX)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Moonshine-Tiny\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Moonshine-Tiny STT Demo")
