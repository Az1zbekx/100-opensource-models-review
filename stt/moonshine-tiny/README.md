# Moonshine-Tiny — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #82**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** ONNX Runtime / PyTorch (27M (Rotary Transformer))  
> **Upstream Repozitoriy:** `UsefulSensors/moonshine-tiny`  
...
**Moonshine-Tiny** — Useful Sensors' sub-30M parameter model that transcribes variable-length audio directly without the 30-second fixed window latency of Whisper.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Instant edge streaming speech recognition without 30-second chunk latency.
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐☆☆ (Optimized for short interactive commands and live wake-words).
...
| **Oylik Server Xarajati** | **$0 (runs on microcontrollers)** | $15–$30/oy (Dedicated VPS/GPU) |
...
|---|---|---|---|---|---|
| **Moonshine-Tiny** | **27M (Rotary Transformer)** | **~0.06x** | **~4.5%** | **~700 MB** | **Instant edge streaming speech recog...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up moonshine-tiny --build
