# Whisper.cpp Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-39M–244M%20(GGUF)-green.svg)]()
[![Engine](https://img.shields.io/badge/Engine-C++%20/%20ggml%20/%20AVX2-orange.svg)]()
[![Quantization](https://img.shields.io/badge/Quantization-Q4_0%20/%20Q5_0%20/%20Q8_0-purple.svg)]()
[![Docker](https://img.shields.io/badge/Docker-Ready-2496ED.svg)]()

Port of OpenAI's Whisper model in pure C/C++ without dependencies, optimized for Apple Silicon, x86 AVX2, and ARM NEON.
...
| :--- | :--- |
| **Model Name** | `Whisper.cpp` (`ggerganov/whisper.cpp`) |
| **Target Project Fit** | High-performance pure C/C++ ASR inference with zero Python runtime overhead |
| **GPU Required?** | **No**. Optimized for fast inference. |
| **RAM / VRAM Footprint** | ~300 MB – 1.5 GB RAM |
| **Estimated Monthly Hosting Cost** | **$0 (runs on bare-metal CPU)** |
| **Same Server as Backend?** | ✅ Yes |
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (High accuracy with GGUF small model, microscopic footprint) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** C++ / ggml / AVX2 (39M–244M (GGUF)).
- **Upstream Model Identifier:** `ggerganov/whisper.cpp`.
- **Quantization & Speed:** Q4_0 / Q5_0 / Q8_0.
...
We tested Whisper.cpp across 3 authentic Uzbek operational audio recordings in `data/`:
