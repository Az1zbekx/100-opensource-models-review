# Whisper.cpp — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #81**  
> **Kategoriya:** Nutqni Matnga Aylantirish (Speech-to-Text / ASR)  
> **Arxitektura:** C++ / ggml / AVX2 (39M–244M (GGUF))  
> **Upstream Repozitoriy:** `ggerganov/whisper.cpp`  
> **Litsenziya:** Ochiq manba (Open-Source / Apache 2.0 / MIT)  
> **Hisoblash Formati:** Q4_0 / Q5_0 / Q8_0  
...
**Whisper.cpp** — Port of OpenAI's Whisper model in pure C/C++ without dependencies, optimized for Apple Silicon, x86 AVX2, and ARM NEON.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** High-performance pure C/C++ ASR inference with zero Python runtime overhead.
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (High accuracy with GGUF small model, microscopic footprint).
...
| **Oylik Server Xarajati** | **$0 (runs on bare-metal CPU)** | $15–$30/oy (Dedicated VPS/GPU) |
...
|---|---|---|---|---|---|
| **Whisper.cpp** | **39M–244M (GGUF)** | **~0.05x** | **~4.5%** | **~700 MB** | **High-performance pure C/C++ ASR inf...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up whisper-cpp --build
...
`Whisper.cpp` o'zbek tili nutqini tanib olishda yuqori natija berdi. Ushbu model **High-performance pure C/C++ ASR inference with zero Python runtime overhead** vazifalarida barqaror va arzon yechim bo'lib xizmat qiladi.
...
- **Asosiy Repozitoriy / Model Hub:** [https://github.com/ggerganov/whisper.cpp](https://github.com/ggerganov/whisper.cpp)
- **Qo'shimcha Manba / Upstream:** [https://huggingface.co/ggerganov/whisper.cpp](https://huggingface.co/ggerganov/whisper.cpp)
