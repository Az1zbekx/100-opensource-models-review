...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper.cpp Speech-to-Text Engine")
    print("  Model: ggerganov/whisper.cpp")
    print("==================================================")
    print("Loading model parameters (39M–244M (GGUF), Compute: Q4_0 / Q5_0 / Q8_0)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper.cpp STT Demo")
