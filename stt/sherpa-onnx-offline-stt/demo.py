...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Sherpa-ONNX-STT Speech-to-Text Engine")
    print("  Model: k2-fsa/sherpa-onnx")
    print("==================================================")
    print("Loading model parameters (30M–80M (ONNX), Compute: INT8 ONNX)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Sherpa-ONNX-STT\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Sherpa-ONNX-STT STT Demo")
