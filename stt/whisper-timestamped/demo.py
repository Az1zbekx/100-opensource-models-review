...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper-Timestamped Speech-to-Text Engine")
    print("  Model: linto-ai/whisper-timestamped")
    print("==================================================")
    print("Loading model parameters (244M (Small base), Compute: INT8 / FP16)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: Whisper-Timestamped\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper-Timestamped STT Demo")
