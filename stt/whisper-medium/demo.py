...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  Whisper-Medium Speech-to-Text Engine")
    print("  Model: openai/whisper-medium")
    print("==================================================")
    print("Loading model parameters (769M (Encoder-Decoder), Compute: FP16 / INT8)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Whisper-Medium STT Demo")
