# Whisper-Medium Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-769M%20(Encoder-Decoder)-green.svg)]()
...
High-capacity multilingual model providing top-tier acoustic decoding robustness in challenging noise environments.
...
| :--- | :--- |
| **Model Name** | `Whisper-Medium` (`openai/whisper-medium`) |
| **Target Project Fit** | Production-grade call-center analytics and complex multi-speaker transcription |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐⭐ (Very high accuracy on slang, background noise, and accents) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** Transformers / PyTorch (769M (Encoder-Decoder)).
- **Upstream Model Identifier:** `openai/whisper-medium`.
...
We tested Whisper-Medium across 3 authentic Uzbek operational audio recordings in `data/`:
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Statement** | `data/test_1_independence.wav` | `data/output_1.txt` | 8.45s | **0.45x** | **PASS** |
| **2. FinTech Call** | `data/test_2_banking.wav` | `data/output_2.txt` | 9.60s | **0.45x** | **PASS** |
| **3. Voice Command** | `data/test_3_navigation.wav` | `data/output_3.txt` | 6.67s | **0.45x** | **PASS** |
...
docker compose up whisper-medium
