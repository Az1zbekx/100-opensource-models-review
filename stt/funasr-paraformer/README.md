# FunASR-Paraformer Speech-to-Text Review & Benchmark

[![Category](https://img.shields.io/badge/Category-STT-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-220M%20(Paraformer)-green.svg)]()
[![Engine](https://img.shields.io/badge/Engine-FunASR%20/%20ONNX-orange.svg)]()
[![Quantization](https://img.shields.io/badge/Quantization-INT8%20ONNX-purple.svg)]()
[![Docker](https://img.shields.io/badge/Docker-Ready-2496ED.svg)]()

Non-autoregressive speech recognition framework engineered for high concurrency enterprise transcription with Glancing Language Models.
...
| :--- | :--- |
| **Model Name** | `FunASR-Paraformer` (`FunASR/paraformer-large`) |
| **Target Project Fit** | Non-autoregressive industrial speech recognition with continuous streaming support |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Ultra-high throughput for multi-channel call recordings) |

---

## ⚙️ Technical Specifications

- **Underlying Architecture:** FunASR / ONNX (220M (Paraformer)).
- **Upstream Model Identifier:** `FunASR/paraformer-large`.
...
We tested FunASR-Paraformer across 3 authentic Uzbek operational audio recordings in `data/`:
...
docker compose up funasr-paraformer
