...
def main(audio_file: str, output_file: str, language: str):
    ...
    print("==================================================")
    print("  FunASR-Paraformer Speech-to-Text Engine")
    print("  Model: FunASR/paraformer-large")
    print("==================================================")
    print("Loading model parameters (220M (Paraformer), Compute: INT8 ONNX)...")
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"Model: FunASR-Paraformer\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="FunASR-Paraformer STT Demo")
