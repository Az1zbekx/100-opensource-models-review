...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  SeamlessM4T-TTS Text-to-Speech Engine")
    ...
    print(f"Loading TTS model: 'SeamlessM4T-TTS' (2.3B / 1.1B UnitY2)...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="SeamlessM4T-TTS TTS Demo")
