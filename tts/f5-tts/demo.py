...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  F5-TTS Text-to-Speech Engine")
    print("  Model: SWivid/F5-TTS")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'F5-TTS' (384M (DiT Flow Matching))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="F5-TTS TTS Demo")
