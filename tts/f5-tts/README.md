# F5-TTS Text-to-Speech Review & Benchmark

[![Category](https://img.shields.io/badge/Category-TTS-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-384M%20(DiT%20Flow%20Matching)-green.svg)]()
[![Engine](https://img.shields.io/badge/Engine-Diffusion%20Transformer%20(DiT)-orange.svg)]()
[![Quantization](https://img.shields.io/badge/Quantization-FP16-purple.svg)]()
[![Docker](https://img.shields.io/badge/Docker-Ready-2496ED.svg)]()

State-of-the-art non-autoregressive speech synthesis system based on Flow Matching with Diffusion Transformer architecture.
...
| :--- | :--- |
| **Model Name** | `F5-TTS` (`SWivid/F5-TTS`) |
| **Target Project Fit** | Non-autoregressive Flow Matching speech synthesis with rapid inference |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Superior zero-shot timbre matching and natural prosody) |

---

## ⚙️ Technical Specifications

- **Model Architecture:** Diffusion Transformer (DiT) / 384M (DiT Flow Matching).
- **Hugging Face / Upstream:** `SWivid/F5-TTS`.
- **Audio Output Format:** WAV (16,000 Hz / 22,050 Hz Mono PCM).
- **Quantization & Optimization:** FP16.
- **Target Latency / RTF:** ~0.22x Real-Time Factor.
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Address** | `data/input_1.txt` | `data/output_1.wav` | 4.2s | **0.22x** | **PASS** |
| **2. FinTech Alert** | `data/input_2.txt` | `data/output_2.wav` | 6.8s | **0.22x** | **PASS** |
| **3. Navigation Prompt**| `data/input_3.txt` | `data/output_3.wav` | 3.5s | **0.22x** | **PASS** |
