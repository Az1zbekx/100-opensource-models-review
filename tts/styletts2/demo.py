...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  StyleTTS2 Text-to-Speech Engine")
    print("  Model: yl4579/StyleTTS2-LibriTTS")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'StyleTTS2' (115M (Diffusion + GAN))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="StyleTTS2 TTS Demo")
