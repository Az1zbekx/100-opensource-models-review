...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Glow-TTS Text-to-Speech Engine")
    print("  Model: kakao/glow-tts")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Glow-TTS' (28M (Flow-based))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Glow-TTS TTS Demo")
