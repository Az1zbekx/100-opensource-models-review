...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Tacotron2 Text-to-Speech Engine")
    print("  Model: nvidia/tacotron2")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Tacotron2' (45M (Seq2Seq + Attention))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Tacotron2 TTS Demo")
