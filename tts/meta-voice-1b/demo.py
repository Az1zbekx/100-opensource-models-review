...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  MetaVoice-1B Text-to-Speech Engine")
    print("  Model: metavoiceio/metavoice-1B-v0.1")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'MetaVoice-1B' (1.2B (Autoregressive))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MetaVoice-1B TTS Demo")
