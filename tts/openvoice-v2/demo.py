...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  OpenVoice-v2 Text-to-Speech Engine")
    print("  Model: myshell-ai/OpenVoice-v2")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'OpenVoice-v2' (60M (Tone Color Converter))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="OpenVoice-v2 TTS Demo")
