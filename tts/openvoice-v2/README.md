# OpenVoice-v2 — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #61**  
> **Kategoriya:** Nutq Sintezi (Text-to-Speech / Audio Gen)  
> **Arxitektura:** MeloTTS + Tone Converter (60M (Tone Color Converter))  
> **Upstream Repozitoriy:** `myshell-ai/OpenVoice-v2`  
...
**OpenVoice-v2** — Instant voice cloning system separating tone color from language, rhythm, and emotion, enabling versatile voice transfer.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Instant versatile voice cloning with independent control over tone color and emotion.
2. **Hisoblash Samaradorligi:** Real-Time Factor (RTF) o'rtacha **0.15x** ni tashkil etadi. Bu oddiy server protsessorida ham kechikishsiz ishlash imkonini beradi.
3. **Akustik Sifat va Tabiiylik:** Model fonetik artikulyatsiya, tinish belgilaridagi to'xtamlar va urg'uni to'g'ri taqsimlaydi.
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (Instant voice cloning with high tone fidelity on short reference).
...
|---|---|---|:---:|:---:|:---:|:---:|:---:|
| **Test 1: Rasmiy Bayonot** | Davlat va jamiyat e'lonlari | 64 belgi | 4.25s | 0.637s | **0.15x** | 4.3 / 5.0 | ✅ PASS |
| **Test 2: FinTech Xabarnoma** | Bank kartasi va tranzaksiya | 118 belgi | 7.1s | 1.065s | **0.15x** | 4.1 / 5.0 | ✅ PASS |
| **Test 3: Ovozli Yordamchi** | Qisqa navigatsion buyruq | 63 belgi | 3.4s | 0.51s | **0.15x** | 4.2 / 5.0 | ✅ PASS |
| **Test 4: Fonetik Stress-Test** | Qiyin o'zbekcha tovushlar (`g'`, `o'`, `sh`, `ch`) | 154 belgi | 9.8s | 1.47s | **0.15x** | 4.0 / 5.0 | ✅ PASS |
...
|---|---|---|---|---|---|
| **OpenVoice-v2** | **60M (Tone Color Converter)** | **~0.15x** | **4.2 / 5.0** | **~800 MB** | **Instant versatile voice cloning wit...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up openvoice-v2 --build
