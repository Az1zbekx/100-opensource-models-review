...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  E2-TTS Text-to-Speech Engine")
    print("  Model: SWivid/E2-TTS")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'E2-TTS' (320M (Flow Matching))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="E2-TTS TTS Demo")
