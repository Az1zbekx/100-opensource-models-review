# SpeechT5-TTS — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #65**  
> **Kategoriya:** Nutq Sintezi (Text-to-Speech / Audio Gen)  
> **Arxitektura:** Hugging Face / PyTorch (150M (SpeechT5))  
> **Upstream Repozitoriy:** `microsoft/speecht5_tts`  
...
**SpeechT5-TTS** — Microsoft unified multi-modal encoder-decoder architecture conditioned on speaker x-vectors for customized voice generation.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Unified encoder-decoder framework with customizable x-vector speaker embeddings.
...
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (High flexibility with speaker embedding injection).
...
|---|---|---|---|---|---|
| **SpeechT5-TTS** | **150M (SpeechT5)** | **~0.19x** | **4.2 / 5.0** | **~800 MB** | **Unified encoder-decoder framework w...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up speecht5-tts --build
