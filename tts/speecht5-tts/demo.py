...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  SpeechT5-TTS Text-to-Speech Engine")
    print("  Model: microsoft/speecht5_tts")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'SpeechT5-TTS' (150M (SpeechT5))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="SpeechT5-TTS TTS Demo")
