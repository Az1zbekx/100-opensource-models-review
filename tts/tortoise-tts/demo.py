...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Tortoise-TTS Text-to-Speech Engine")
    print("  Model: neonbjb/tortoise-tts")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Tortoise-TTS' (400M (Autoregressive + Diffusion))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Tortoise-TTS TTS Demo")
