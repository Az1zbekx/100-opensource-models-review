...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Piper-TTS Text-to-Speech Engine")
    print("  Model: rhasspy/piper")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Piper-TTS' (15M (VITS ONNX))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Piper-TTS TTS Demo")
