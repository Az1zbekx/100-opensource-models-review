...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Coqui-XTTS-v2 Text-to-Speech Engine")
    print("  Model: coqui/XTTS-v2")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Coqui-XTTS-v2' (467M (Tortoise-derived))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Coqui-XTTS-v2 TTS Demo")
