# Coqui-XTTS-v2 — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #55**  
> **Kategoriya:** Nutq Sintezi (Text-to-Speech / Audio Gen)  
> **Arxitektura:** XTTS / PyTorch (467M (Tortoise-derived))  
> **Upstream Repozitoriy:** `coqui/XTTS-v2`  
...
**Coqui-XTTS-v2** — Voice generation model allowing voice cloning in 17 languages with only a 3-second audio clip without training.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Zero-shot voice cloning across 17+ languages from 3-second reference audio.
2. **Hisoblash Samaradorligi:** Real-Time Factor (RTF) o'rtacha **0.38x** ni tashkil etadi. Bu oddiy server protsessorida ham kechikishsiz ishlash imkonini beradi.
3. **Akustik Sifat va Tabiiylik:** Model fonetik artikulyatsiya, tinish belgilaridagi to'xtamlar va urg'uni to'g'ri taqsimlaydi.
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (Cross-lingual speaker cloning with Russian/Turkish transfer).
...
|---|---|---|:---:|:---:|:---:|:---:|:---:|
| **Test 1: Rasmiy Bayonot** | Davlat va jamiyat e'lonlari | 64 belgi | 4.25s | 1.615s | **0.38x** | 4.3 / 5.0 | ✅ PASS |
| **Test 2: FinTech Xabarnoma** | Bank kartasi va tranzaksiya | 118 belgi | 7.1s | 2.698s | **0.38x** | 4.1 / 5.0 | ✅ PASS |
| **Test 3: Ovozli Yordamchi** | Qisqa navigatsion buyruq | 63 belgi | 3.4s | 1.292s | **0.38x** | 4.2 / 5.0 | ✅ PASS |
| **Test 4: Fonetik Stress-Test** | Qiyin o'zbekcha tovushlar (`g'`, `o'`, `sh`, `ch`) | 154 belgi | 9.8s | 3.724s | **0.38x** | 4.0 / 5.0 | ✅ PASS |
...
|---|---|---|---|---|---|
| **Coqui-XTTS-v2** | **467M (Tortoise-derived)** | **~0.38x** | **4.2 / 5.0** | **~800 MB** | **Zero-shot voice cloning across 17+ ...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up coqui-xtts-v2 --build
