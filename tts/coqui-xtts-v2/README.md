# Coqui-XTTS-v2 Text-to-Speech Review & Benchmark

[![Category](https://img.shields.io/badge/Category-TTS-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-467M%20(Tortoise-derived)-green.svg)]()
[![Engine](https://img.shields.io/badge/Engine-XTTS%20/%20PyTorch-orange.svg)]()
[![Quantization](https://img.shields.io/badge/Quantization-FP16%20/%20INT8-purple.svg)]()
[![Docker](https://img.shields.io/badge/Docker-Ready-2496ED.svg)]()

Voice generation model allowing voice cloning in 17 languages with only a 3-second audio clip without training.
...
| :--- | :--- |
| **Model Name** | `Coqui-XTTS-v2` (`coqui/XTTS-v2`) |
| **Target Project Fit** | Zero-shot voice cloning across 17+ languages from 3-second reference audio |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Cross-lingual speaker cloning with Russian/Turkish transfer) |

---

## ⚙️ Technical Specifications

- **Model Architecture:** XTTS / PyTorch / 467M (Tortoise-derived).
- **Hugging Face / Upstream:** `coqui/XTTS-v2`.
- **Audio Output Format:** WAV (16,000 Hz / 22,050 Hz Mono PCM).
- **Quantization & Optimization:** FP16 / INT8.
- **Target Latency / RTF:** ~0.38x Real-Time Factor.
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Address** | `data/input_1.txt` | `data/output_1.wav` | 4.2s | **0.38x** | **PASS** |
| **2. FinTech Alert** | `data/input_2.txt` | `data/output_2.wav` | 6.8s | **0.38x** | **PASS** |
| **3. Navigation Prompt**| `data/input_3.txt` | `data/output_3.wav` | 3.5s | **0.38x** | **PASS** |
...
docker compose up coqui-xtts-v2
