...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Bark-Small Text-to-Speech Engine")
    print("  Model: suno/bark-small")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Bark-Small' (100M + 100M (Dual GPT))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Bark-Small TTS Demo")
