...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  FastSpeech2 Text-to-Speech Engine")
    print("  Model: espnet/fastspeech2")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'FastSpeech2' (30M (Feed-Forward))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="FastSpeech2 TTS Demo")
