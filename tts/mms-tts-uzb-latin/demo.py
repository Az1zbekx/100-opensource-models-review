...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  MMS-TTS-UZB (Latin) Text-to-Speech Engine")
    print("  Model: facebook/mms-tts-uzb-script_latin")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'MMS-TTS-UZB (Latin)' (145M (VITS))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MMS-TTS-UZB (Latin) TTS Demo")
