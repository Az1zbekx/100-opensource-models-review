...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Parler-TTS-Mini Text-to-Speech Engine")
    ...
    print(f"Loading TTS model: 'Parler-TTS-Mini' (880M (DAC + Transformer))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Parler-TTS-Mini TTS Demo")
