...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  MMS-TTS-KAZ Text-to-Speech Engine")
    print("  Model: facebook/mms-tts-kaz")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'MMS-TTS-KAZ' (145M (VITS))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MMS-TTS-KAZ TTS Demo")
