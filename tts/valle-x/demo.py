...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  VALL-E-X Text-to-Speech Engine")
    print("  Model: microsoft/VALL-E-X")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'VALL-E-X' (330M (Neural Codec LM))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="VALL-E-X TTS Demo")
