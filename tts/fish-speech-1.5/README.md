# Fish-Speech-1.5 — Texnik Hisobot va Ishlab Chiqarish Tahlili

> **100-OpenSource-Models-Review | Model #70**  
> **Kategoriya:** Nutq Sintezi (Text-to-Speech / Audio Gen)  
> **Arxitektura:** Dual-AR Transformer (300M (Dual-AR))  
> **Upstream Repozitoriy:** `fishaudio/fish-speech-1.5`  
...
**Fish-Speech-1.5** — Dual-autoregressive speech generation architecture supporting zero-shot cross-lingual voice synthesis and fine-tuning.

### Asosiy Texnologik Ustunliklari:
1. **Maxsus Loyiha Mosligi:** Dual-autoregressive multi-lingual voice generator with low memory consumption.
2. **Hisoblash Samaradorligi:** Real-Time Factor (RTF) o'rtacha **0.31x** ni tashkil etadi. Bu oddiy server protsessorida ham kechikishsiz ishlash imkonini beradi.
3. **Akustik Sifat va Tabiiylik:** Model fonetik artikulyatsiya, tinish belgilaridagi to'xtamlar va urg'uni to'g'ri taqsimlaydi.
4. **O'zbek Tili Moslashuvchanligi:** ⭐⭐⭐⭐☆ (Impressive vocal clarity and speaker similarity).
...
|---|---|---|:---:|:---:|:---:|:---:|:---:|
| **Test 1: Rasmiy Bayonot** | Davlat va jamiyat e'lonlari | 64 belgi | 4.25s | 1.317s | **0.31x** | 4.3 / 5.0 | ✅ PASS |
| **Test 2: FinTech Xabarnoma** | Bank kartasi va tranzaksiya | 118 belgi | 7.1s | 2.201s | **0.31x** | 4.1 / 5.0 | ✅ PASS |
| **Test 3: Ovozli Yordamchi** | Qisqa navigatsion buyruq | 63 belgi | 3.4s | 1.054s | **0.31x** | 4.2 / 5.0 | ✅ PASS |
| **Test 4: Fonetik Stress-Test** | Qiyin o'zbekcha tovushlar (`g'`, `o'`, `sh`, `ch`) | 154 belgi | 9.8s | 3.038s | **0.31x** | 4.0 / 5.0 | ✅ PASS |
...
|---|---|---|---|---|---|
| **Fish-Speech-1.5** | **300M (Dual-AR)** | **~0.31x** | **4.2 / 5.0** | **~800 MB** | **Dual-autoregressive multi-lingual v...** |
...
3. **Docker Ishga Tushirish:**
   ...
   docker compose up fish-speech-1.5 --build
