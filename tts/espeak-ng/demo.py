...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  eSpeak-NG Text-to-Speech Engine")
    print("  Model: espeak-ng/espeak-ng")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'eSpeak-NG' (2M (Formant rules))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="eSpeak-NG TTS Demo")
