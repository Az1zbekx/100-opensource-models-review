...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  ChatTTS Text-to-Speech Engine")
    print("  Model: 2noise/ChatTTS")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'ChatTTS' (200M (Autoregressive + Flow))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ChatTTS TTS Demo")
