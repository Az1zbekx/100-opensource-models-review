...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Coqui-TTS-VITS Text-to-Speech Engine")
    print("  Model: coqui/tts-vits")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'Coqui-TTS-VITS' (35M (VITS))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Coqui-TTS-VITS TTS Demo")
