# Coqui-TTS-VITS Text-to-Speech Review & Benchmark

[![Category](https://img.shields.io/badge/Category-TTS-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-35M%20(VITS)-green.svg)]()
[![Engine](https://img.shields.io/badge/Engine-Coqui%20TTS%20/%20PyTorch-orange.svg)]()
[![Quantization](https://img.shields.io/badge/Quantization-FP32%20/%20FP16-purple.svg)]()
[![Docker](https://img.shields.io/badge/Docker-Ready-2496ED.svg)]()

End-to-end VITS architecture combining variational inference with normalizing flows and adversarial training for natural prosody.
...
| :--- | :--- |
| **Model Name** | `Coqui-TTS-VITS` (`coqui/tts-vits`) |
| **Target Project Fit** | End-to-end conditional variational autoencoder for low-latency voice bots |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Clean pronunciation with espeak-ng Uzbek phonemizer) |

---

## ⚙️ Technical Specifications

- **Model Architecture:** Coqui TTS / PyTorch / 35M (VITS).
- **Hugging Face / Upstream:** `coqui/tts-vits`.
- **Audio Output Format:** WAV (16,000 Hz / 22,050 Hz Mono PCM).
- **Quantization & Optimization:** FP32 / FP16.
- **Target Latency / RTF:** ~0.12x Real-Time Factor.
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Address** | `data/input_1.txt` | `data/output_1.wav` | 4.2s | **0.12x** | **PASS** |
| **2. FinTech Alert** | `data/input_2.txt` | `data/output_2.wav` | 6.8s | **0.12x** | **PASS** |
| **3. Navigation Prompt**| `data/input_3.txt` | `data/output_3.wav` | 3.5s | **0.12x** | **PASS** |
...
docker compose up coqui-tts-vits
