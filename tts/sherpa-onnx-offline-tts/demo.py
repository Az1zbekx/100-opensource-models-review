...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  Sherpa-ONNX-TTS Text-to-Speech Engine")
    ...
    print(f"Loading TTS model: 'Sherpa-ONNX-TTS' (25M (VITS ONNX))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Sherpa-ONNX-TTS TTS Demo")
