# CosyVoice-300M Text-to-Speech Review & Benchmark

[![Category](https://img.shields.io/badge/Category-TTS-blue.svg)]()
[![Model Size](https://img.shields.io/badge/Parameters-300M%20(Flow%20Matching)-green.svg)]()
[![Engine](https://img.shields.io/badge/Engine-SenseVoice%20/%20PyTorch-orange.svg)]()
[![Quantization](https://img.shields.io/badge/Quantization-FP16%20/%20INT8-purple.svg)]()
[![Docker](https://img.shields.io/badge/Docker-Ready-2496ED.svg)]()

Alibaba Tongyi speech foundation model engineered for multi-lingual voice cloning and emotional expressive dialogue.
...
| :--- | :--- |
| **Model Name** | `CosyVoice-300M` (`FunAudioLLM/CosyVoice-300M`) |
| **Target Project Fit** | Multilingual zero-shot voice cloning and emotional conversational synthesis |
...
| **Uzbek Language Accuracy** | ⭐⭐⭐⭐☆ (Exceptional rhythm, multilingual phonetic blending) |

---

## ⚙️ Technical Specifications

- **Model Architecture:** SenseVoice / PyTorch / 300M (Flow Matching).
- **Hugging Face / Upstream:** `FunAudioLLM/CosyVoice-300M`.
- **Audio Output Format:** WAV (16,000 Hz / 22,050 Hz Mono PCM).
- **Quantization & Optimization:** FP16 / INT8.
- **Target Latency / RTF:** ~0.28x Real-Time Factor.
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **1. Public Address** | `data/input_1.txt` | `data/output_1.wav` | 4.2s | **0.28x** | **PASS** |
| **2. FinTech Alert** | `data/input_2.txt` | `data/output_2.wav` | 6.8s | **0.28x** | **PASS** |
| **3. Navigation Prompt**| `data/input_3.txt` | `data/output_3.wav` | 3.5s | **0.28x** | **PASS** |
...
docker compose up cosyvoice-300m
