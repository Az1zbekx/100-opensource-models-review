...
def main(input_file: str, output_file: str):
    print("==================================================")
    print("  CosyVoice-300M Text-to-Speech Engine")
    print("  Model: FunAudioLLM/CosyVoice-300M")
    print("==================================================")
    ...
    print(f"Loading TTS model: 'CosyVoice-300M' (300M (Flow Matching))...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="CosyVoice-300M TTS Demo")
