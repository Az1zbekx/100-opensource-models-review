...
def main():
    ...
    test_files = [
        ...
        ("input_2_uzbek_comprehension.txt", "output_2_uzbek_comprehension.txt", 800, 0.2),
        ("input_3_logic_deduction.txt", "output_3_logic_deduction.txt", 600, 0.1),
        ("input_4_strict_json_tool_call.txt", "output_4_strict_json_tool_call.txt", 800, 0.1),
    ]

    print("==========================================================")
    print("  🌐 Alibaba Qwen2.5-3B Benchmark Suite Runner")
    print("==========================================================")
    ...
    for inp_name, out_name, max_tok, temp in test_files:
        ...
        formatted = format_qwen_prompt(prompt_text)
    ...
    print("All Qwen2.5-3B tests completed successfully.")
