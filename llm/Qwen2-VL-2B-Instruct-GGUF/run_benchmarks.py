...
def main():
    data_dir = "data"
    test_cases = [
        ("input_1_traffic_vqa.txt", "test_intersection.jpg", "output_1_traffic_vqa.txt", 1024, 0.2),
        ("input_2_office_audit.txt", "test_office.jpg", "output_2_office_audit.txt", 1024, 0.2),
        ("input_3_spatial_reasoning.txt", "test_intersection.jpg", "output_3_spatial_reasoning.txt", 1024, 0.2),
        ("input_4_uzbek_multimodal_analysis.txt", "test_office.jpg", "output_4_uzbek_multimodal_analysis.txt", 1024, 0.2),
    ]

    print("==========================================================")
    print("  👁️ Qwen2-VL-2B Multimodal Benchmark Suite Runner")
    print("==========================================================")
    ...
    print("Initializing Qwen25VLChatHandler and Llama engine...")
    ...
    print(f"Model and vision projector loaded in {time.time() - t0:.2f}s.\n")
    ...
    print("All Qwen2-VL-2B tests completed successfully.")
