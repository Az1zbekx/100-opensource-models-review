...
def main():
    ...
    test_files = [
        ...
        ("input_4_code_concurrency_python.txt", "output_4_code_concurrency_python.txt", 1024, 0.2),
    ]

    print("==========================================================")
    print("  💎 Google Gemma-2-2B Benchmark Suite Runner")
    print("==========================================================")
    ...
    for inp_name, out_name, max_tok, temp in test_files:
        ...
        formatted = format_gemma_prompt(prompt_text)
    ...
    print("All Gemma-2-2B tests completed successfully.")
